...
int main()
{
	...
	int BlinnPhongProgram, currentProgram, GouraudProgram, FlatProgram,ToonProgram,BorderProgram;
	unsigned int BlinnPhong_vertexShader, BlinnPhong_fragmentShader;
	unsigned int Gouraud_vertexShader, Gouraud_fragmentShader;
	unsigned int Flat_vertexShader, Flat_geomtryShader, Flat_fragmentShader;
	unsigned int Toon_vertexShader, Toon_fragmentShader;
	unsigned int Border_vertexShader, Border_fragmentShader;
	BlinnPhong_vertexShader = createShader("shaders/Blinn-Phong.vert", "vert");
	BlinnPhong_fragmentShader = createShader("shaders/Blinn-Phong.frag", "frag");
	BlinnPhongProgram = createProgram(BlinnPhong_vertexShader,0, BlinnPhong_fragmentShader);
	Gouraud_vertexShader = createShader("shaders/Gouraud.vert", "vert");
	Gouraud_fragmentShader = createShader("shaders/Gouraud.frag", "frag");
	GouraudProgram = createProgram(Gouraud_vertexShader, 0, Gouraud_fragmentShader);
	Flat_vertexShader = createShader("shaders/Flat.vert", "vert");
	Flat_geomtryShader = createShader("shaders/Flat.geom", "geom");
	Flat_fragmentShader = createShader("shaders/Flat.frag", "frag");
	FlatProgram = createProgram(Flat_vertexShader, Flat_geomtryShader, Flat_fragmentShader);
	Toon_vertexShader = createShader("shaders/Toon.vert", "vert");
	Toon_fragmentShader = createShader("shaders/Toon.frag", "frag");
	ToonProgram = createProgram(Toon_vertexShader, 0, Toon_fragmentShader);
	Border_vertexShader = createShader("shaders/Border.vert", "vert");
	Border_fragmentShader = createShader("shaders/Border.frag", "frag");
	BorderProgram = createProgram(Border_vertexShader, 0, Border_fragmentShader);
